    ...
    <div className="bg-slate-100 mt-5">
     ...
     <div className="basis-1/4">
        ...
        <div className="basis-1/4">
          ...
          <div className="flex-col">
            <p className="mt-2">Biện pháp đối phó với đại dịch COVID-19 của chúng tôi</p>
     ...
     <hr />
        ...
        <p className="text-lg basis-3/4">© 2021 Airbnb, Inc. All rights reserved - Quyền riêng tư - Điều khoản - Sơ đồ trang web</p>
